...
SRC_URI = "${SOURCEFORGE_MIRROR}/owfs/owfs-${PV}.tar.gz \
           file://owhttpd \
           file://owserver  \
           file://001-disable-python-config.patch \
           file://002-fix-python-install-path.patch"
...
EXTRA_OECONF = " \
                 ...
                 --with-pythonconfig="${STAGING_BINDIR_NATIVE}/python-native/python-config" \
...
export PYTHONPATH = "${STAGING_LIBDIR_NATIVE}/python2.7/"
...
do_install_append() {
    chrpath -d ${D}/usr/lib/python2.7/site-packages/ow/_OW.so
}

PACKAGES =+ "owftpd owhttpd owserver owshell libowcapi libow libownet owmon owtap owpython-dbg owpython ownetpython"


DESCRIPTION_owpython = "Python binding for owfs"
DESCRIPTION_ownetpython = "Python binding for ownet"
...
FILES_owpython-dbg = "${libdir}/python2.7/site-packages/ow/.debug"
FILES_owpython = "${libdir}/python2.7/site-packages/ow ${libdir}/python2.7/site-packages/ow-*"
FILES_ownetpython = "${libdir}/python2.7/site-packages/ownet ${libdir}/python2.7/site-packages/ownet-*"
